...
export default function CreateTactic() {
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Draggable
        x={195} y={450}
        onDragRelease={(e) => setPositions3(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={350} y={450}
        onDragRelease={(e) => setPositions4(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={110} y={600}
        onDragRelease={(e) => setPositions5(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={280} y={600}
        onDragRelease={(e) => setPositions6(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={25} y={680}
        onDragRelease={(e) => setPositions7(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={100} y={740}
        onDragRelease={(e) => setPositions8(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={290} y={740}
        onDragRelease={(e) => setPositions9(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={370} y={680}
        onDragRelease={(e) => setPositions10(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
      ...
      <Draggable
        x={195} y={800}
        onDragRelease={(e) => setPositions11(e.nativeEvent.pageX, e.nativeEvent.pageY)}
      >
        <View style={styles.players}>
          <TextInput
            placeholder={"...."}
