  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.UpcomingEvents}>
        <TouchableOpacity>
          <Text style={styles.EventsText}>Next training is tomorrow</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.TheSchedule}>
        <TouchableOpacity>
          <Text style={styles.EventsText}>Here will the Schedule place</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.ChoosenDay}>
        <TouchableOpacity>
          <Text style={styles.todayText}>
            Here will the the info about the choosen day on schedule show. It
            will not be avail if they hav'nt picked any day
          </Text>
        </TouchableOpacity>
      </View>
    </View>
