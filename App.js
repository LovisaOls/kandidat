...
const iconHome = () => (
  <Icon name="ios-home" size={34}></Icon>
);
...
const iconCalendar = () => (
  <Icon name="ios-calendar-outline" size={34}></Icon>
);

const iconTactic = () => (
  <Icon name="ios-football" size={34}></Icon>
)
      ...
      <Router>
        <Stack>
          <Scene key="root" hideNavBar={true}>
            ...
            <Scene key="Profile" component={MyProfileScreen} />
